/** Purchase handlers with per-month sheet tabs */
function purchaseHandlePost(payload) {
  const propKey = 'SHEET_ID_PURCHASE'
  ...
  // determine month tab: use payload.date if provided, else today
